(ns clojisr.v1.renjin
  (:require [clojisr.v1.session :as session]
            [clojisr.v1.impl.renjin.session :refer [make]]
            #_[cemerick.pomegranate :refer [add-dependencies]]
            ))

(set! *warn-on-reflection* true)

#_(add-dependencies :coordinates '[[org.renjin/renjin-script-engine "RELEASE"]]
...
#_(require '[clojisr.v1.impl.renjin.session :refer [make]])
