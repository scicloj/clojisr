...
- the Clojure notions used as the equivalent of R's "data frames" and "matrices": Incanter / core.matrix (see [Clojure's counterparts of R's data abstractions](clojure_counterparts.mdm))
