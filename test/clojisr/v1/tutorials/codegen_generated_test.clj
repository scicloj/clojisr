...
(deftest
 test69
 (is ((fn* [p1__47422#] (Double/isNaN p1__47422#)) var68)))
...
(def
 ...
 (->code
  (zipmap
   (map (fn* [p1__47423#] (str "key" p1__47423#)) (range 100))
   (range 1000 1100))))
...
(def
 ...
 (->
  (r
   (zipmap
    (map (fn* [p1__47424#] (str "key" p1__47424#)) (range 100))
    (range 1000 1100)))
  r->clj
  :key23))
